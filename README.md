...
## Quick installer
Install ChipAP from your RaspberryPi's shell prompt:
```sh
$ wget -q https://git.io/voEUQ -O /tmp/chipap && bash /tmp/chipap
```
...
sudo git clone https://github.com/billz/chipap-webgui /var/www/html
```
Set the files ownership to `www-data` user.
```sh
sudo chown -R www-data:www-data /var/www/html
```
Move the ChipAP configuration file to the correct location
```sh
sudo mkdir /etc/chipap
sudo mv /var/www/html/chipap.php /etc/chipap/
sudo chown -R www-data:www-data /etc/chipap
```
